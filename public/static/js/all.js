...
/* harmony import */ var _popups__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./popups */ "./resources/assets/js--sources/modules/popups.js");
/* harmony import */ var _tables__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tables */ "./resources/assets/js--sources/modules/tables.js");
/* harmony import */ var _tables__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_tables__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _truncateText_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./truncateText.js */ "./resources/assets/js--sources/modules/truncateText.js");
/* harmony import */ var _sliders_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sliders/index */ "./resources/assets/js--sources/modules/sliders/index.js");
...
var Iconify = function (e) {
  ...
  function f(e) {
    ...
    for (var i in a) {
      if (void 0 !== e[i] && _typeof(e[i]) !== a[i]) return null;
    }
    ...
    for (var c in o) {
      ...
      for (var u in t) {
        if (void 0 !== f[u] && _typeof(f[u]) != _typeof(t[u])) return null;
      }
    }
    ...
    if (s) for (var l in s) {
      ...
      for (var p in t) {
        if (void 0 !== v[p] && _typeof(v[p]) != _typeof(t[p])) return null;
      }
    }
    return r;
  }
  ...
  for (var te = Object.create(null), re = ['https://api.simplesvg.com', 'https://api.unisvg.com'], ie = []; re.length > 0;) {
    1 === re.length || Math.random() > 0.5 ? ie.push(re.shift()) : ie.push(re.pop());
  }
...
if ('object' == ( false ? 0 : _typeof(exports))) try {
  for (var key in exports.__esModule = !0, exports["default"] = Iconify, Iconify) {
