<div class="mob-nav">
    <div class="mob-nav__top">
        <div class="mob-nav__container mob-nav__container--top container">
            <button class="mob-nav__burger hamburger hamburger--collapse" type="button" aria-label="Открыть меню"
                    :class="overlayIsOpen &amp;&amp; 'is-active'" @click="overlayIsOpen = true">
            ...
            @if(Route::is('main'))
                <a class="mob-nav__logo" href="javascript:void(0)" title="На главную" aria-label="На главную">
                    <img class="mob-nav__pic" src="/static/images/common/logo--mobile.svg" width="88" height="30"
            ...
            @endif
            <button class="mob-nav__actions btn-reset" type="button" data-popup="data-popup" data-src="#write-popup"
