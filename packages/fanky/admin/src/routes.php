...
Route::group(['namespace' => 'Fanky\Admin\Controllers', 'prefix' => 'admin', 'as' => 'admin'], function () {
	...
	Route::group(['as' => '.main-slider', 'prefix' => 'main-slider'], function () {
		$controller  = 'AdminMainSliderController@';
        Route::get('/', $controller . 'getIndex');
        ...
        Route::post('image-delete/{id}', $controller . 'postImageDelete')
            ->name('.image-delete');

        Route::post('reorder', $controller . 'postReorder')
            ->name('.reorder');

        Route::post('feats-upload/{id?}', $controller . 'postFeatsUpload')
            ->name('.feats-upload');

        Route::post('feats-reorder', $controller . 'postFeatsReorder')
            ->name('.feats-reorder');

        Route::post('feat-del/{id}', $controller . 'postFeatDel')
            ->name('.feat-del');

        Route::post('feat-edit/{id}', $controller . 'postFeatEdit')
            ->name('.feat-edit');

        Route::post('feat-save/{id}', $controller . 'postFeatSave')
            ->name('.feat-save');
	});
