            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-8">{{ $order->dateFormat('d.m.Y, g:i') }}</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8"><a href="mailto:{{$order->email}}" title="Написать письмо">{{ $order->email }}</a></div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 text-bold">Сумма</div>
                        <div class="col-md-8"><strong>{{ number_format($all_summ, 0, '', ' ') }} руб.</strong></div>
                    </div>
                </div>
            </div>
        </div>
