...
{{--                <li><a href="#tab_2" data-toggle="tab">Текст</a></li>--}}
                ...
                @if($object->id)
                    <li class="pull-right">
                        <a href="{{ route('objects.item', [$object->id]) }}" target="_blank">Посмотреть</a>
                    </li>
                @endif
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    ...
                    {!! Form::groupText('city', $object->city, 'Город') !!}
                    ...
                    <div class="form-group">
                        <label for="article-image">Изображение (458x306)</label>
                        <input id="article-image" type="file" name="image"
                               accept=".jpg,.jpeg,.png" onchange="return newsImageAttache(this, event)">
                    ...
                    {!! Form::groupCheckbox('on_main', 1, $object->on_main, 'Показывать на главной') !!}
                </div>
                    ...
                    @if ($object->id)
                        ...
                        <div class="images_list">
                            @foreach ($object->images as $image)
                                @include('admin::objects.object_image')
                            @endforeach
                        </div>
                    @else
